  ...
  return (
    <>
      ...
      <Container className='mt-5'>
        <h2 class="text-center mt-0">At User Feature</h2>
        <Row className='justify-content-between my-5'>
          <Col className="text-center mx-2 mb-5" md={3}>
            ...
            <h3 class="h4 my-2">Problem Reporter</h3>
            <p class="text-muted mb-0">Send your Problem to Operator Contribute to helping the organization</p>
          </Col>
          <Col className="text-center mx-2 mb-5" md={3} >
            <img className='' width={100} src='src\assets\tracker.svg'></img>
            <h3 class="h4 my-2">Track Status</h3>
            <p class="text-muted mb-0">Recognize and Follow your problem status</p>
          </Col>
          <Col className="text-center mx-2 mb-5" md={3} >
            <img className='' width={100} src='src\assets\admin.svg'></img>
            <h3 class="h4 my-2">Contact With Operator</h3>
            <p class="text-muted mb-0">You can private contact with Operator for fixing problem</p>
          </Col>
        </Row>
